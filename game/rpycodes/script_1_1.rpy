...
label episode1_1:
    ...
    #（转换成书吧背景）
    play music "bgm/testbgm/BGM12.ogg" fadein 1
    scene black
    show library with tran_lf
    hide library with tran_lf
    $ renpy.pause(0.5, hard=True)
    show consultdesk with tran_lf
    ...
    show lan size1 a2 amazing with Dissolve(0.2):
        zoom 1.4
        xcenter 0.5
        yalign 1.0
    ...
    l size1 a3 little_serious"当然是志愿工作啦！"
    voice sustain

    #show

    voice "voice/l_voice/episode1/蘭004.mp3"
    l size1 a1 proud"才不会像某些人一样，只有闲到无聊的时候才会过来转转"
    voice sustain
    ...
    voice sustain
    l size1 a3 mad"你在乱说什么呀？！"
    voice sustain
    #show
    voice "voice/l_voice/episode1/蘭006.mp3"
    voice sustain
    l size1 a1 little_serious"请注意礼貌用语，不要随便用‘弄’这个词"
    voice sustain
    #show
    voice "voice/l_voice/episode1/蘭007.mp3"
    voice sustain
    l size1 a3 mad"海川该不会是在把本小姐污蔑成像小偷那样子的角色吧？"
    voice sustain
    ch ". . . . . ."
    voice sustain
    ch ". . . . . ."
    ...
    voice sustain
    l size1 a3 little_serious"这是我的新校服"
    voice sustain
    ch "校服？"
    voice sustain
    ...
    voice sustain
    l size1 a3 mad"喂！一直盯着女生的胸部也太无礼了吧！"
    voice sustain
    ...
    voice sustain
    l size2 a1 smile"总之，海川羡慕我是没有用的. . .这都是靠我自己的努力才换来的"
    #show
    voice "voice/l_voice/episode1/蘭012.mp3"
    voice sustain
    l size2 a1 proud"正所谓‘天道酬勤’"

    #show

    voice "voice/l_voice/episode1/蘭013.mp3"
    voice sustain
    l size2 a2 "像你这种懒人肯定是不懂这种道理的"
    voice sustain
    ch ". . . . . ."
    voice sustain
    ...
    voice sustain
    l size2 a1 happy"无事不登三宝殿，说吧，你到这儿来有什么目的"
    voice sustain
    #show
    voice "voice/l_voice/episode1/蘭015.mp3"
    voice sustain
    l size2 a3 smile"还是说. . ."
    #show
    ...
    voice sustain
    l size1 a3 little_serious"海川这样的人. . .怎么可能. . ."
    ...
    voice sustain
    l size1 a2 amazing"真是不可思议，你的名字竟然真的能出现在这份名单上"
    #show
    voice "voice/l_voice/episode1/蘭022.mp3"
    voice sustain
    l size2 a3 little_serious"有没有一种可能，我手上拿的这份交换生名单是假的？"
    voice sustain
    ch ". . . . . ."
    voice sustain
    ...
    voice sustain
    l size2 a3 normal"所以说，海川渡是来填写哪个学校的交换项目信息啊？"
    ch "东番国立高大"
    #show
    l ". . . . . ."
    l ". . . . . ."
    ...
    voice sustain
    l size2 a3 little_serious"学校真的会收留你吗？"
    voice sustain
    ch ". . . . . ."
    voice sustain
    ...
    voice sustain
    l size2 a1 little_serious"可真是倒霉"
    #show
    voice "voice/l_voice/episode1/蘭029.mp3"
    voice sustain
    l size2 a2 sad"一想到还要和海川在同一所学校里相处四年半的时间，我就浑身难受. . ."
    ch ". . . . . ."
    ...
    voice sustain
    l size2 a2 wry_smile"不过我是真没想到，唯二的名额能被海川分走一个"

    #show

    voice "voice/l_voice/episode1/蘭031.mp3"
    voice sustain
    l size2 a2 normal"你还是蛮有本事的嘛，"

    #show

    voice "voice/l_voice/episode1/蘭032.mp3"
    voice sustain
    l size2 a2 smile"完全超出了本小姐的预料"

    #show

    voice "voice/l_voice/episode1/蘭033.mp3"
    voice sustain
    l size2 a3 smile"那么，海川肯定和我一样，是‘新媒体传播与交叉演出’专业，对吧？"
    voice sustain
    ch ". . . . . ."
    voice sustain
    ch "不是的"
    ...
    voice sustain
    l size2 a3 little_serious"让我看看. . .填报院系. . .‘仿生机器人制造技术’，不愧是你. . ."
    #（立绘上切换成蘭无语的表情）
    #show
    ...
    voice sustain
    l size2 a2 little_serious"我还以为你会继续学习演出的. . ."
    #show
    voice "voice/l_voice/episode1/蘭036.mp3"
    voice sustain
    l size2 a2 normal"到头来还都是奔着造机器人去啊"

    #show

    voice "voice/l_voice/episode1/蘭037.mp3"
    voice sustain
    l size2 a2 proud"真不愧是你啊. . .‘PTFOD’的演出社社长"
    voice sustain
    ...
    voice sustain
    l size2 a4 normal"诺，这是你需要填写的信息，就在这个表格里面，填满就可以了"
    voice sustain
    ch "谢谢"
    voice sustain
    "我接过填写表"
    ...
    voice sustain
    l size2 a1 little_serious"能给我一个理由吗"
    voice sustain
    ch "什么？"
    voice sustain
    #show
    ...
    voice sustain
    l size2 a3 normal"明明这么喜欢演出，但最后还是去了机器人制造专业"
    #show
    ...
    voice sustain
    l size2 a2 normal"喂喂，你刚刚听到了我问你的问题了吧？"
    voice sustain
    ch ". . ."
    voice sustain
    #show
    ...
    voice sustain
    l size2 a3 normal"该不会是在计较昨天晚上和秋月的事情吧？"
    voice sustain
    ...
    voice sustain
    l size1 a3 little_serious"但是你明明更喜欢表演吧，真是奇怪的执念"
    #show
    ...
    voice sustain
    l size1 a1 wry_smile"明明可以大胆追求自己喜欢做的事情啊！"
    voice sustain
    ...
    voice sustain
    l size1 a1 serious"这就是我不喜欢你的理由"
    voice sustain
    ch ". . . . . ."
    voice sustain
    "好吧，收回刚才我说的话"
    ...
    #show
    hide lan size1 a3 mad with Dissolve(0.2)
    voice "voice/yqtt_voice/episode1/岩崎004.mp3"
    voice sustain
    yq size1 a1 happy "好了好了，不耽误小蘭的时间"
    #show
    ...
    voice sustain
    yq size1 a1 proud  "我才会专门调用能够快速跨越长江的异界载具. . ."
    voice sustain
    ch "是九衢市50型地铁二号线转五号线"
    voice sustain
    #show
    ...
    voice sustain
    yq size1 a1 little_serious "喂喂，你还没有感谢我呢！"
    #show
    voice "voice/yqtt_voice/episode1/岩崎011.mp3"
    voice sustain
    yq size1 a1 sad "就这样把我辛辛苦苦护送过来的魔法结社传唤申请给拿走了. . .明明是你自己把东西落下了"
    #show
    voice "voice/l_voice/episode1/蘭051.mp3"
    voice sustain
    l size2 a2 sad"才. . .才不是"
    ...
    voice sustain
    yq size1 a1 little_sad "小蘭，你躲我干什么啊. . ."
    #show
    voice "voice/l_voice/episode1/蘭055.mp3"
    voice sustain
    l size1 a1 serious"别. . .别一口一个‘小蘭’的，真让人讨厌！"
    #show
    voice "voice/yqtt_voice/episode1/岩崎016.mp3"
    voice sustain
    yq size1 a1 sad "明明之前出游的时候还让我偷偷喊你‘妹妹’的. . ."
    #show
    voice "voice/l_voice/episode1/蘭056.mp3"
    voice sustain
    l size1 a3 mad"你！你. . .我不许你再说了！"
    #show
    ...
    voice sustain
    yq size1 a1 happy "嘿嘿，我明白了"
    ch "岩崎天桐朝向我不自然地咧嘴笑了笑"
    #show
    voice "voice/yqtt_voice/episode1/岩崎018.mp3"
    voice sustain
    yq size1 a1 smile "那我就先行告辞了"
    #show
    ...
    show yq size4 a1 leave:
        ...
        zoom 1.2
    with Dissolve(0.2)
    hide yq size4 a1 leave
    with Dissolve(0.5)
    hide lan size1 a3 mad
    with Dissolve(0.2)
    "在和蘭的推推搡搡中，岩崎天桐很快就消失在我的视线中"
    #show
    play music "bgm/testbgm/BGM12.ogg"
    voice "voice/l_voice/episode1/蘭060.mp3"
    voice sustain
    show lan size2 a1 sad:
        xalign 0.5
        yalign 1.0
        zoom 1.4
    with Dissolve(0.2)
    ...
    voice sustain
    l size1 a3 mad"真是的. . .还非要摆出这一副傲慢的态度. . ."
    "到底是谁更傲慢一点啊喂. . ."
    ch "看来岩崎中二的个性还是没有改变啊"
    ...
    voice sustain
    l size1 a3 little_serious"喂喂，刚才的表你填完了吗？"
    voice sustain
    ch "嗯，填完了"
    voice sustain
    "蘭打断了我的胡乱臆想. . .可能也只是错觉吧？"
    ...
    voice sustain
    l size2 a1 little_serious"等等！忘记和你说要拿校服了"
    voice sustain
    ...
    voice sustain
    l size2 a3 little_serious"为什么海川不会想着携带一个robot入学呢？"
    voice sustain
    ch "是学校强制要求的吗？"
    #show
    voice "voice/l_voice/episode1/蘭072.mp3"
    voice sustain
    l size2 a3 normal"不是的，只是这样的话会方便很多"
    #show
    ...
    voice sustain
    l size2 a2 proud"看来海川还真是不问世事呀，被消息隔离也是理所当然的吧"
    voice sustain
    ...
    voice sustain
    l size2 a4 normal"不过这多的两件校服，你真的不拿着吗？"
    ...
    voice sustain
    l size1 a3 proud"要知道东番国立大学的校服可是别人想要都要不到的哟"
    "说完，蘭再次专门挺了挺自己胸前的胸章，似乎是非常满意与自豪的样子"
    #show
    voice "voice/l_voice/episode1/蘭086.mp3"
    voice sustain
    l size1 a3 smile"我想这件校服肯定会留给有需要的人. . ."
    #show
    ...
    voice sustain
    l size1 a1 little_serious"你. . ."
    #show
    voice "voice/l_voice/episode1/蘭089.mp3"
    voice sustain
    l size1 a1 serious"你还真是不知好歹啊！"#（恼）
    #show
    voice "voice/l_voice/episode1/蘭090.mp3"
    voice sustain
    l size1 a1 wry_smile"呼. . .算了，不和你这种榆木脑袋解释了"
    #show
    voice "voice/l_voice/episode1/蘭091.mp3"
    voice sustain
    l size1 a3 smile"好了好了，快从本小姐面前闪开"
    #show
    ...
    hide consultdesk
    hide lan size1 a3 smile
    with tran_uf
    scene street afternoon with tran_uf
    ...
    "她说"
    "后来"
    "他们都在这座高楼中从事着仿生机器人技术制造的工作"
    "她好像是在8岁的时候，就收到了一份来自父母给她的礼物"
    "她告诉我说"

    #（此处切入线稿1，并进行变换，第一张为单纯的黄色背景）

    show memory_1 with dissolve
    ...
    "要是我也能有这样一个极具真实感的姐姐就好了"
    "哪怕是一个仿生机器人也足够满足我的各种幻想了. . ."
    "但有时，这样的真实感却会让让我背后一凉. . . . . ."
    "很多年之后，或许我就不能分辨出人和真正的机器人的区别"
    "这还是很让我后怕的想法. . ."

    hide memory_1 with dissolve
    ...
    #voice ""
    #（播放细细簌簌的声响声）
    hide cx size2 a2 serious with Dissolve(0.1)
    show cx size2 a2 serious:
        xalign 0.2
        yalign 1.0
        zoom 1.1
    ...
    #（后续初咲一直采用日语对话）
    #show
    hide cx size2 a2 serious with Dissolve(0.2)
    show cx size2 a1 normal:
        xalign 0.5
        yalign 1.0
        zoom 1.1
    with Dissolve(0.2)
    ...
    stop music fadeout 1.0
    hide cx size2 a1 normal
    show cx size2 a1 normal:
        xalign 0.5
        yalign 1.0
        zoom 1.1
    with Dissolve(0.2)
    play music "bgm/testbgm/BGM62.ogg"
    ch "你. . ."
    ...
    play music "bgm/testbgm/BGM10.ogg"  fadein 1
    who "回答正确！"#（非常高兴的声音）
    ...
    hide cx size2 a4 happy
    show cx size2 a4 smile:
        xalign 0.5
        yalign 1.0
        zoom 1.4
    with Dissolve(0.2)
    ...
    cq size2 a2 serious"果然"
    #show
    ch "喂喂！这会让人很不自在的"
    "然后少女又慢悠悠地转到我的面前"
    #show
    voice "voice/cxly_voice/episode1/初咲028.mp3"
    cq size4 a1 smile"呐，海川君...我听说过你！"
    #show
    ...
    cq size2 a2 normal"容许我重新自我介绍一下，"
    #show
    voice "voice/cxly_voice/episode1/初咲036.mp3"
    cq size2 a3 smile"主人给我取的名字是‘初咲恋柚’"
    #show
    voice "voice/cxly_voice/episode1/初咲037.mp3"
    cq size2 a3 smile"是型号为‘JAPAN-20500101-LASER-PTF-04’的新世代仿生机器人"
    voice sustain
    ...
    cq size2 a3 wry_smile"可以不用日语对我说噢"
    #show
    ...
    #（切换场景：家门口的背景）
    scene home afternoon with tran_lf
    ...
    #（切换场景：客厅的背景，稍微带一点科技感）
    scene livingroom afternoon with tran_lf
    play music "bgm/testbgm/BGM18.ogg"
    ch "我回来了！"
    "打开门后，我习惯地向家里说了这句话"
    "没有人答应我"
    "原来都走了啊. . ."
    ...
    ch "应该. . ."
    stop music fadeout 2.0
    play music "bgm/testbgm/BGM16.ogg" fadein 1.0
    #voice ""
    #（插入手机铃声的"叮"，开始播放广播~）
    ...
    #voice ""
    jqgb "据最新报道，九衢市近期出现了多起‘霸凌机器人’事件"
    "据悉，该事件多发于沙湖路段"
    "在此，提醒各位主人保护好自己的机器人，目前相关的霸凌案件仍在调查中. . ."
    ch "霸凌机器人. . ."
    ch "沙湖路段. . ."
    ch "这不就是在这附近发生的事情吗？"
    #（这里插入暗黄色色调+
    ...
    scene black
    show door night with tran_lf
    hide door night with tran_lf
    show sky night with tran_lf
    hide sky night with tran_lf
    show park night with tran_lf
    ...
    ch "应该这样就会好很暖和很多吧. . ."
    #（放效果音："沙沙"，像是树叶在地上被吹动的声音）
    "不知道在什么时候，我的背后出现了一个黑漆漆的影子，正在我的身后无声地注视着我地所作所为"
    #show
    ...
    show cx size2 a3 normal:
        ...
        zoom 1.4
    with Dissolve(0.2)
    play music "bgm/testbgm/BGM10.ogg" fadein 1.0
    #（放效果音：门铃声）
    #voice ""
    ...
    hide cx size2 a3 smile
    with tran_lf
    scene livingroom night with tran_lf
    show cx size2 a3 normal:
        xalign 0.5
        yalign 1.0
        zoom 1.4
    ...
    play music "bgm/testbgm/BGM18.ogg" fadein 1.0
    #（播放倒在床上的效果音，"啪"）
    "我径直倒在床上"
    "今天连澡都没有洗. . ."
