...
label episode2_2:
    ...
    cq "这是我第一次真正在舞台上表演. . .那个. . ."
    cq "看起来怎么样？"
    xy "这演技至少在我认识的同学中绝对算是很不错的了"
    xy "初咲学妹看上去很有干劲的样子呢"  #（此时微笑）
    ...
    cq "太天真了，主人看来是完全没有常识的吧？"
    cq "即兴演出一般是有很多场，分为不同的表演内容。"
    cq "这样更能体现出演出者的能力和心理素质哦！"
    xy "没错"  #（此时微笑）
    ch "我明白了"
    xy "那么请海川来扮演‘凯旋的骑士’，初咲是‘骑士的追随者’，开始吧！"
    ...
    "只是真的被吓到了而已. . ."
    "好哦，得到前辈的认可了！"
    xy "不过让我很好奇的是，明明我还没有把道具发给你. . .没想到初咲学妹还会随身带着这么危险的东西"
    ...
    cq "嘿嘿. . .不会主人以为我真的会就那样就亲上去吧？"
    ch "咳咳，拜托就不要再调侃我了"
    xy "好啦，初咲同学的演技还是很厉害的，已经可以做到以假乱真了"
    cq "真的吗！谢谢，我会继续加油的！"
    xy "海川同学的话，还要好好磨练一下表演的能力"
    xy "就算有着强烈的感情，如果不能传达给观众的话，那也是没用的"
    ch "嗯，我知道的"
    "那句话，还是被西野学姐说出来了. . ."
    xy "今天就先到这里吧，从现在开始海川同学和初咲同学也算正式入部的部员了"
    cq "好耶，我们要好好庆祝一番了！"
    ch "咳咳，拜托就不要再调侃我了"
    ...
    xy "初咲学妹是不用退出创作演绎部的"
    ch "这是可以的吗？刚刚学姐的意思不是. . ."
    xy "以初咲学妹的能力，完全可以在部门里给各位做出表率的"
    ch "也就是说. . .初咲恋柚也只能是担当大家的表率吗？"
    xy ". . ."
    xy "其实，‘创作演绎部’也是今年刚刚成立的"
    ...
    l "我会亲自完成创作演绎部的第一本剧本"
    ch "创作演绎部？？？"
    cq "也是在西野学姐的那个大剧院里工作吗？"
    voice "voice/l_voice/episode2/e2 蘭 025.mp3"
    l "是的. . .诶？你们怎么都知道？"
    yq "以海川和初咲这样对演出的热爱，他们肯定也加入了‘创作演绎部’"
    yq "这才是值得讴歌的青春啊！"
    ...
    yq "虽然从robot的‘署名’上来说，初咲的主人可能在登记的时候换了一个名字. . ."
    ...
    yq "毕竟都走到这一步了,不帮也是不行啊"
    voice "voice/l_voice/episode2/e2 蘭 044.mp3"
    l "喂喂，不会说话就不要说，好好听初咲讲完"
    cq "真的很感谢大家！"
    cq "不过我完全不记得之前主人的事情了"
